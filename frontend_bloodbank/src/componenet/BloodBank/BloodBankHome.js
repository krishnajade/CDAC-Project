 ...
 */}
 ...
 const logoutUser = () => {
  ...
  window.location.reload(false);
   ...
   return (
     <div>
      <button className="btn btn-info" id="logout-btn" onClick={logoutUser}>Logout</button>
 <div class="container rounded bg-white mt-5 mb-5 ">
 
               <h1 className="label-control text-center m-3 text-success fw-bold">Welcome {bloodbank_name}</h1>
               <div class="row">
                   <div class="center  border-right">
                       <div class="d-flex flex-column align-items-center text-center p-3 py-2">
                           <img class="mt-1" width="5px" src={bloodbankicon} alt="" style={{
         width: 300,
         height: 350,
         borderRadius: 140 / 2,
         ...
         <div class="center  border-right">
            ...
            <tr >
        <Link to={``}><button className="btn btn-danager col-4 rounded-pill" onClick={profile} style={{
         width: 250,
         height: 50,
         borderRadius: 140 / 2,
      ...
      {/*  <Link to={`/BloodBankList`}><button className="btn btn-danager col-4 ms-3  rounded-pill  mt-2 " style={{
         ...
         <Link to={`/bloodrequest`}><button className="btn btn-danager col-4 rounded-pill" style={{
         width: 250,
         height: 50,
         marginLeft:15,
         marginRight:15,
     ...
     }} ><b>Request List for Blood</b></button></Link>    

      <Link to={`/requestpage`}><button className="btn btn-danager col-4 rounded-pill " style={{
         width: 250,
         height: 50,
         borderRadius: 140 / 2,
     ...
     }} ><b>Appointment List</b></button></Link> 
        </tr>
        <tr> 
        <Link to={`/bloodstock`}><button className="btn btn-danager col-4  rounded-pill" style={{
         width: 250,
         height: 50,
         borderRadius: 140 / 2,
     ...
     }} ><b>Show Blood Stock</b></button></Link> 
      <Link to={``}><button className="btn btn-danager col-4  rounded-pill " onClick={showbloodstock} style={{
         width: 250,
         height: 50,
         marginLeft:15,
         marginRight:15,
    ...
    {/* <Link to={``}><button className="btn btn-danager col-4  ms-3 rounded-pill mt-2 mb-2" style={{
     ...
     <Link to={`/bloodstockform`}><button className="btn btn-danager col-4  rounded-pill "style={{
         width: 250,
         height: 50,
         borderRadius: 140 / 2,
     ...
     }} ><b>Add Blood Stock</b></button></Link> 
                    </tr>
                    <div></div>
                 </div>
              </div>
