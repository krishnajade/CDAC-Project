                    ...
                    <div class="col-sm-2" >
                      ...
                      <div class="col-sm-8 mt-3" id="signupForm">
                        ...
                        <div className="form" >
                          ...
                          <div className="mb-3">
                          <input name="bloodbank_name" type="text " className="form-control" placeholder="Enter Blood Bank Name ex. Appolo Blood Bank" 
                          value={reg.bloodbank_name} onChange={(e)=>{dispatch({type:'update',field:'bloodbank_name',val:e.target.value})}} />
                          </div>
                          <p className="text-danger">{formErrors.bloodbank_name}</p>
                          <div className="mb-3">
                          <input name="username" type="text " className="form-control" placeholder="Enter User Name ex.appolo_1254"
                          value={reg.username} onChange={(e)=>{dispatch({type:'update',field:'username',val:e.target.value})}}  required />
                          </div>
                          <p className="text-danger">{formErrors.username}</p>
                          
                          <div className="mb-3">
                          <input name="licenceno" type="text" className="form-control" placeholder="Enter Licence No ex. 32541"
                          value={reg.licenceno} onChange={(e)=>{dispatch({type:'update',field:'licenceno',val:e.target.value})}} required />
                          </div>
                          ...
                          <div className="mb-3">
                          <input name="city" type="text " className="form-control" placeholder="Enter City ex. Pune, Mumbai etc."
                           value={reg.city} onChange={(e)=>{dispatch({type:'update',field:'city',val:e.target.value})}}  required />
                          </div>
                          <p className="text-danger">{formErrors.city}</p>
                          <div className="mb-3">
                          <input name="phonenumber" type="number" className="form-control" placeholder="Enter Phone Number" 
                          ...
                          <div className="mb-3">
                          <input name="email" type="email" className="form-control" placeholder="Enter Email ex. bloodbank@gmail.com etc." 
                           value={reg.email} onChange={(e)=>{dispatch({type:'update',field:'email',val:e.target.value})}} required />
                          </div>
                          <p className="text-danger">{formErrors.email}</p>
                          <div className="mb-3">
                          <input name="website" type="email" className="form-control" placeholder="Enter website ex. www.bloodbank.com etc." 
                          ...
                          value={reg.password} onChange={(e)=>{dispatch({type:'update',field:'password',val:e.target.value})}} required />
                          </div>
                          ...
                          <div className="mb-3 text-center mt-2">
                            ...
                            <button  className="btn btn-md btn-block btn-danger fw-bold" style={{ marginLeft: "10px" }}
                             type="reset"  onClick={()=>{dispatch({type:'clear'})}}>
                              Clear
                            </button>
                          </div>
                          {msg}
