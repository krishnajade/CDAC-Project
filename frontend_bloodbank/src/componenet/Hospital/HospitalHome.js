        ...
        <div class="center  border-right">
          <div class="d-flex flex-column align-items-center text-center p-3 py-2">
            <img
              class="mt-1"
              width="5px"
              src="https://st.depositphotos.com/2204608/3026/v/950/depositphotos_30267159-stock-illustration-bright-and-colorful-vector-hospital.jpg"
              alt=""
              style={{
                width: 300,
                height: 350,
          ...
          <div className="d-grid gap-4">
            <tr>
              <Link to={""}>
                <button
                  onClick={profile}
                  className="btn btn-danager col-4 ms-3 rounded-pill mt-2 "
                  style={{
                    textDecoration: null,
                    width: 350,
                    height: 50,
       ...
       <Link to={`/BloodBankList`}><button className="btn btn-danager col-4 ms-3  rounded-pill  mt-2 " style={{
        ...
        transform: [
          { scaleX: 2 }
              ...
              <Link to={`/PatientList`}>
                <button
                  className="btn btn-danager col-4 rounded-pill mt-2"
                  style={{
                    width: 350,
                    height: 50,
                    borderRadius: 140 / 2,
            ...
            <tr>
              <Link to={`/PatientRegistation`}>
                <button
                  className="btn btn-danager col-4  ms-3 rounded-pill mt-2 mb-2"
                  style={{
                    width: 350,
                    height: 50,
                    borderRadius: 140 / 2,
