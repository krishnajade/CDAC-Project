...
const RejectedHospitalRequest=()=>{

    const[request,setRequest]=useState([]);
    const[id,setId]=useState(0);

    useEffect(()=>{
        fetch(`http://localhost:8080/Hospitalrequestbystatus?hospital_id=${sessionStorage["hospital_id"]}&request_status=Rejected`)
        .then(resp=> resp.json())
    ...
    */}
    ...
    return(
        ...
        <div className="container-fluids">
            <div id="bloodstock">
                <h2 id="headline"><b>Rejected Hospital Request List</b></h2>
...
export default RejectedHospitalRequest;