...
function ChangePassword() {
  ...
  const handleSubmit = (e) => {
    ...
    axios.put(`http://localhost:8080/updatPassword?user_id=${sessionStorage["user_id"]}&password=${formValues.password}`) 
    .then((res) => {
  ...
  return (
    <div className="container" id="login-form">
      ...
      <form onSubmit={handleSubmit} >
        <h1 className="label-control text-center m-3 text-success fw-bold" >Change Password</h1>
        <hr/>
        ...
        <hr/>
          <div >
          <button className="btn btn-md btn-block btn-success fw-bold">Submit</button>
